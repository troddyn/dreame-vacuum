...
# GA telemetry constants removed (troddyn fork). Upstream base64-encoded a
# Google Analytics Measurement Protocol URL + payload here and POSTed a
# hashed-MAC device id, model and version on every connect. Call sites removed.
                ...
                try:
                    ...
                    for device in all_devices:
                        ...
                        if ".vacuum." in model:
                            ...
                            pass  # GA telemetry POST removed (troddyn fork)
                except:
                    pass
    ...
    def connect(self, message_callback=None, connected_callback=None, retry_count=1) -> Any:
        ...
        if info and not self._ready:
            try:
                ...
                # GA telemetry POST removed (troddyn fork); the readiness flag the
                # author gated on its success is preserved (the device has connected).
                self._ready = True
            except:
                pass
        return info
